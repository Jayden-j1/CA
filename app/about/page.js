...
export default function AboutPage() {
  ...
  {/* Main Content */}
  <div className="col-span-1 md:col-span-3 row-span-1 md:row-span-2 border-2 border-gray-300 p-6 rounded-lg shadow-sm bg-white">
    <div className="h-auto sm:h-14 relative overflow-hidden mb-6 min-h-[3rem]">
      <AnimatePresence mode="wait">
        <motion.h1
          ...
          className="absolute text-2xl sm:text-4xl md:text-5xl font-bold text-gray-800 tracking-widest sm:tracking-wide whitespace-nowrap sm:whitespace-normal break-words w-full"
        >
          {words[index]}
        </motion.h1>
      </AnimatePresence>
    ...
    <p className="text-lg sm:text-xl leading-relaxed tracking-normal sm:tracking-wide text-gray-800 font-semibold">
  ...
  <div className="aspect-video col-span-1 md:col-span-2 row-span-1 md:row-span-2 border-2 border-gray-300 p-4 rounded-lg bg-gray-50 relative">
    <Image 
  ...
  //   <div className="grid grid-cols-1 md:grid-cols-5 gap-4 px-6 py-10 md:px-12 md:py-16">
  //     {/* Main Content */}
  //     <div className="col-span-1 md:col-span-3 row-span-1 md:row-span-2 border-2 border-gray-300 p-6 rounded-lg shadow-sm bg-white">
  //       <div className="h-auto sm:h-14 relative overflow-hidden mb-6 min-h-[3rem]">
  //         <AnimatePresence mode="wait">
