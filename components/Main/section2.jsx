...
export default function Section2({
  ...
  return (
    <section
      ref={ref}
      className="relative flex flex-col justify-center items-center min-h-[85vh] sm:min-h-screen bg-white px-4 sm:px-6"
    >
      ...
      <motion.h2
        ...
        className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold leading-tight tracking-tight text-center mb-6 text-gray-800 bg-clip-text"
      ...
      <AnimatePresence mode="wait">
        <motion.p
          ...
          className="text-lg sm:text-xl md:text-2xl lg:text-2xl leading-relaxed md:leading-loose tracking-wide text-gray-600 max-w-3xl whitespace-pre-line mt-6 mb-10 text-left"
