...
// export interface TopOfPageContentProps {
//   HeadingOneTitle: string;
//   paragraphContent: string;
//   linkOne: string;
//   href?: string;
//   // Accept a React mouse event from anchor elements
...
//             onClick={onClick} // now typed correctly
//           >
//             {linkOne}
//           </a>
//         </div>
...
// // // These props describe the text and link details for the hero section.
// // interface TopOfPageContentProps {
// //   HeadingOneTitle: string | ReactNode; // Main heading (can be plain text or JSX)
// //   paragraphContent: string | ReactNode; // Supporting paragraph
// //   linkOne: string | ReactNode;          // Label for the button/link
...
// //     // Delay animation start to the next tick
// //     const timeout = setTimeout(() => {
// //       cycleColors();
// //     }, 0);
