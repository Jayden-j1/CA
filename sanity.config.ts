...
// Purpose
// -------
// Single source of truth for Sanity Studio config.
// Delegate to /cms/sanity.config.ts so Studio loads schemas from /cms/schemas
// (including the new Module.thumbnail field).
//
// Safety
// ------
// • No changes to Next.js app logic, payments, progress, or course UI.
// • Affects only how Studio reads schemas at dev/build time.
