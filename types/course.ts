// types/course.ts
//
// Change: add optional `thumbnail?: string | null` to CourseModule.
// This is UI-only metadata and does not affect course logic.
...
export interface CourseModule {
  ...
  title: string;
  description?: string;
  // ✅ NEW: optional thumbnail URL (Sanity CDN) to render beside the title
